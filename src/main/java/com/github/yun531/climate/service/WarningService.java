...
public class WarningService {
    ...
    public Map<Integer, Map<WarningKind, WarningStateDto>> findLatestByRegionAndKind(List<Integer> regionIds) {
        ...
        Map<Integer, Map<WarningKind, WarningStateDto>> result = initResultSkeleton(regionIds);

        // DB에서 모든 WarningState 로드
        List<WarningState> warningStates = loadStates(regionIds);

        // regionId + kind 별로 최신 상태 선별
        Map<Integer, Map<WarningKind, WarningState>> pickedWarningStates =
    ...
    private Map<Integer, Map<WarningKind, WarningStateDto>> initResultSkeleton(List<Integer> regionIds) {
    ...
    private List<WarningState> loadStates(List<Integer> regionIds) {
     ...
     */
    private Map<Integer, Map<WarningKind, WarningState>> selectLatestStates(
            List<WarningState> rows,
            Set<Integer> validRegionIds
    ) {
    ...
    private void fillResult(
            Map<Integer, Map<WarningKind, WarningStateDto>> result,
            Map<Integer, Map<WarningKind, WarningState>> pickedEntities) {
